...
<nav>
    <div class="container justify-content-lg-end align-items-lg-center">
        <div class="row d-flex justify-content-end align-items-center" style="height: 35px;">
            <div class="col-auto d-md-flex align-items-md-center" style="padding: 0px;"><a class="nav-link-top"
                    href="/help" style="border-right: 2px solid var(--bs-emphasis-color);">Help</a></div>
