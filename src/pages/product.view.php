                        ...
                        <?php if ($product['has_AR'] == 1) { ?>
                            <div class="accordion-item border-top border-primary-subtle">
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
                                    ...
                                    <a href="/AR/<?= $product['ar_id'] ?>" class="text-primary"><svg
                                            xmlns="http://www.w3.org/2000/svg" height="32" fill="currentColor"
                                            viewBox="0 0 640 512">
                                            <path
                    ...
                    <div class="col-12 col-lg-10">
                        <div class="d-flex flex-column flex-sm-row gap-3">
                            ...
                            <div>
                                ...
                                <p class="fw-medium fs-6 text-secondary mb-0"> <?= $review['formatted_date'] ?> </p>
